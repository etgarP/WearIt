...
export default function ConnectedMatchRoute({ setProfilePage, navigation, designersData }) {
    ...
    }, [priceFilter, categoryFilter, subcategoryFilter, reviewFilter, searchText, designersData]);  // Include designersData as a dependency
